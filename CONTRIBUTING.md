...
2. Details on what versions of node, fastify and fastify-couchdb you are using (`node -v`).
3. The version of CouchDB server you are running against.
4. A simple repeatable test case for us to run. Please try to run through it 2-3 times to ensure it is completely repeatable.
